...
#     tasks = request.form.getlist('task')  # Using getlist to capture multiple tasks
#     sleep_hours = request.form.get('sleep_hours')

#     # Example: You can now process the tasks and generate a schedule
#     # For now, just display the entered tasks
#     schedule = f"Tasks: {tasks}, Sleep: {sleep_hours} hours"
